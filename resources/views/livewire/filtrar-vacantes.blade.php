    ...
    <div class="max-w-7xl mx-auto">
        <form wire:submit.prevent='leerDatosFormulario'>
            <div class="md:grid md:grid-cols-3 gap-5">
                ...
                <div class="mb-5">
                    <label class="block mb-1 text-sm text-gray-700 rounded-md uppercase font-bold">Categoría</label>
                ...
                <div class="mb-5">
                    <label class="block mb-1 text-sm text-gray-700 rounded-md uppercase font-bold">Salario Mensual</label>
